...
DROP TABLE [USER];
--ALTER TABLE [Article]
--DROP CONSTRAINT FK_Article_ArtUSERId;
----DROP CONSTRAINT [FK_BMoney_UserId] ;
--DROP CONSTRAINT  [PK_ID];
--DROP CONSTRAINT [FK_USER_INVITEDBY] ;
--DROP COLUMN InvitedBy;

GO
 --ADD CONSTRAINT [FK_USER_INVITEDBY] FOREIGN KEY ([INVITEDBY])
 --ADD CONSTRAINT [PK_ID] PRIMARY KEY CLUSTERED ([ID] ASC);
 --CONSTRAINT [FK_BMoney_UserId] FOREIGN KEY ([UserId]) REFERENCES [dbo].[USER] ([ID])
