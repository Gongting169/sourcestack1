...
SELECT TITLE FROM  PROBLEM  WHERE  TLTLE  NOT LIKE N'_____数据库%' AND TITLE  LIKE  N'%#%%' ESCAPE '#';

SELECT TITLE FROM  PROBLEM  WHERE  TLTLE  NOT LIKE N'_____%数据库%' AND TITLE  LIKE  N'%#%%' ESCAPE '#';
