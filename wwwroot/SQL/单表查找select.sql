...
--以Problem中的数据为基础，使用SELECT INTO，新建一个Author和Reward都没有NULL值的新表：NewProblem （把原Problem里Author或Reward为NULL值的数据删掉） 
SELECT AUTHOR , REWARD  INTO NEWPROBLEM  FROM PROBLEM1   WHERE  AUTHOR IS NOT NULL AND  REWARD  IS NOT NULL;

SELECT AUTHOR , REWARD  INTO NEWPROBLEM  FROM PROBLEM1   WHERE  AUTHOR IS NOT NULL OR  REWARD  IS NOT NULL;
...
BEGIN TRAN 
INSERT  NEWPROBLEM 
SELECT AUTHOR ,REWARD   From PROBLEM1 WHERE  REWARD IS  NULL;
