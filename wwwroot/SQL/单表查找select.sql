...
INSERT [PROBLEM1] ([ID]  ,REWARD ,NeedRemoteHelp ) VALUES(3,5,1);
...
INSERT [PROBLEM1] ([ID] ,AUTHOR ,NeedRemoteHelp ) VALUES(16,N'小黄',12);
INSERT [PROBLEM1] ([ID] ,REWARD ,NeedRemoteHelp ) VALUES(17,6,7);
INSERT [PROBLEM1] ([ID] ,AUTHOR ,NeedRemoteHelp ) VALUES(18,N'小黄',5);

INSERT [PROBLEM1] ([ID]  ,REWARD,NeedRemoteHelp ) VALUES(19,5,3);
INSERT [PROBLEM1] ([ID] ,AUTHOR ,NeedRemoteHelp ) VALUES(20,N'小黄',5);
...
--查找并统计出每个作者的：求助数量、悬赏总金额和平均值 
SELECT AUTHOR,SUM (NeedRemoteHelp),SUM(REWARD),AVG(REWARD)  AS [COUNT] FROM PROBLEM1 
GROUP BY AUTHOR ;
...
--以Problem中的数据为基础，使用SELECT INTO，新建一个Author和Reward都没有NULL值的新表：NewProblem （把原Problem里Author或Reward为NULL值的数据删掉） 
SELECT *  INTO NEWPROBLEM  FROM PROBLEM1  WHERE  AUTHOR IS NOT NULL AND  REWARD  IS NOT NULL;

--使用INSERT SELECT, 将Problem中Reward为NULL的行再次插入到NewProblem中 
BEGIN TRAN 
INSERT  NEWPROBLEM 
SELECT [ID] ,[AUTHOR] ,[REWARD] ,[NeedRemoteHelp]  From PROBLEM1 WHERE  REWARD IS  NULL;
